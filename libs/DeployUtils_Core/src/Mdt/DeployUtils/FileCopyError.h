 ...
 **
 ****************************************************************************/
#ifndef MDT_DEPLOY_UTILS_EXECUTABLE_FILE_COPY_ERROR_H
...
namespace Mdt{ namespace DeployUtils{
  ...
  class MDT_DEPLOYUTILS_EXPORT FileCopyError : public QRuntimeError
  {
   public:
    ...
    /*! \brief Constructor
     */
    explicit FileCopyError(const QString & what)
      : QRuntimeError(what)
    {
    }
...
#endif // #ifndef MDT_DEPLOY_UTILS_EXECUTABLE_FILE_COPY_ERROR_H
