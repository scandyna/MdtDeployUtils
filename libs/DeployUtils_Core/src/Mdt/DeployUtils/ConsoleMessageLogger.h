 ...
 **
 ****************************************************************************/
#ifndef MDT_DEPLOY_UTILS_CONSOLE_MESSAGE_LOGGER_H
...
namespace Mdt{ namespace DeployUtils{
  ...
  /*! \brief Console output logger backend implementation
   *
   * \sa MessageLogger
   */
...
#endif // #ifndef MDT_DEPLOY_UTILS_CONSOLE_MESSAGE_LOGGER_H
